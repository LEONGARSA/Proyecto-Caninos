"""
Django settings for DJANG_CRUD_API project.
...
SECRET_KEY = 'django-insecure-$ys)vx-($!3gs4git^m8yav-b9l^i@dl9#^=u@jl+m5v#hruse'
...
ROOT_URLCONF = 'DJANG_CRUD_API.urls'
...
WSGI_APPLICATION = 'DJANG_CRUD_API.wsgi.application'
